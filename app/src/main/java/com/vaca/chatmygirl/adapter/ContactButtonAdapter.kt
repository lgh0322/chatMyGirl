...
class ContactButtonAdapter(var context: Context) :
    RecyclerView.Adapter<ContactButtonAdapter.ViewHolder>() {
    interface WantInfo {
        fun go(u: Int)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater.inflate(R.layout.item_contact_button, parent, false)
