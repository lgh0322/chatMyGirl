...
import com.vaca.chatmygirl.popadapter.UserHeightAdapter

@SuppressLint("ClickableViewAccessibility")
class HeightPop(mContext: Context, r: ReceiveInfo, initValue: String?) : PopupWindow() {
    ...
    init {
        val view = LayoutInflater.from(mContext).inflate(R.layout.pop_height, null)
        ...
        sexPick.apply {
            setWheelItemCount(5)
            setAdapter(UserHeightAdapter(heightInit))
