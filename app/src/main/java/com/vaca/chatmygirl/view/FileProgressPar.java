package com.vaca.chatmygirl.view;
...
import com.vaca.chatmygirl.utils.Utils;
...
public class FileProgressPar extends View {
    ...
    public FileProgressPar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FileProgressPar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        centy = (height - Utils.dip2px(getContext(), 0.8f)) * 0.5f;
