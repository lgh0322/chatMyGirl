...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    public static void show(Context context, int position, ArrayList<String> paths) {
        Intent i = new Intent(context, ImagePreviewActivity.class);
        i.putStringArrayListExtra(EXTRA_PATHS, paths);
        i.putExtra(SELECTED_POSITION, position);
        i.putExtra(ONLY_PREVIEW, true);
    ...
    private void initData() {
        ...
        boolean isOnlyPreview = getIntent().getBooleanExtra(ONLY_PREVIEW, false);
        mCheckedBtn.setVisibility(isOnlyPreview ? View.GONE : View.VISIBLE);
        rl_bottom.setVisibility(isOnlyPreview ? View.GONE : View.VISIBLE);
