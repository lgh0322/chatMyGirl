...
import com.video.meng.multi.image.adapter.FolderAdapter;
import com.video.meng.multi.image.adapter.ImageGridAdapter;
import com.video.meng.multi.image.bean.Folder;
import com.video.meng.multi.image.bean.Image;
import com.video.meng.multi.image.utils.FileUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //   getActivity().getSupportLoaderManager().initLoader(LOADER_ALL, null, mLoaderCallback);  //过时了
    ...
    public void onAttach(@NonNull Context context) {
        ...
        this.activity = (MultiImageSelectorActivity) context;
    }

    private void getCameraPermission() {
        if (activity != null) {
            activity.setNeedPermission(new MultiImageSelectorActivity.PermissionCallBack() {
                @Override
    ...
    /**
     * 选择相机
     * buildsdk是>=24,所以调用Uri.fromFile时会报错
     */
